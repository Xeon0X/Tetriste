                ...
                new KeyEventDispatcher() {
                    ...
                    public boolean dispatchKeyEvent(KeyEvent e) {
                        if (e.getID() == KeyEvent.KEY_PRESSED) {
                            switch (e.getKeyCode()) {
                                case KeyEvent.VK_Q -> matrix.action(Direction.LEFT);
                                case KeyEvent.VK_D -> matrix.action(Direction.RIGHT);
                                case KeyEvent.VK_S -> matrix.action(Direction.SOFT_DROP);
                                case KeyEvent.VK_Z -> matrix.action(Direction.UP);
